...
test_that("Convert from WGS84 to Pseudo-Mercator", {
  expect_equal(sgs_points_xy(sgs_wgs84_en(sgs_points(list(54.2, 18.5),
                                                     epsg=4326))),
               c(2059410.580, 7208125.261), check.attributes=FALSE)
  expect_equal(sgs_points_xy(sgs_wgs84_en(sgs_points(list(46.78, 113.4),
                                                     epsg=4326))),
               c(12623630.256, 5906238.114), check.attributes=FALSE)
  expect_equal(sgs_points_xy(sgs_wgs84_en(sgs_points(list(67.8, 16.9),
                                                     epsg=4326))),
