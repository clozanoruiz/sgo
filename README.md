...
[![CRAN](https://www.r-pkg.org/badges/version/sgo.png)](https://cran.r-project.org/package=sgo)
...
[![status](https://tinyverse.netlify.app/badge/sgo.png)](https://cran.r-project.org/package=sgo)
...
Model
OSTN15](https://www.ordnancesurvey.co.uk/blog/ostn15-new-geoid-britain/).
...
library(maps)
maps::map('world', regions = ('uk'), xlim = c(-9, 0), ylim = c(54.5, 60.9))
...
bv <- sgo_points(
  list(x = 247455, y = 706338, name = "Ben Venue"),
  coords = c("x", "y"),
  epsg = 27700
)
sgo_bng_ngr(bv)$ngr
...
munros <- data.frame(
  ngr = c("NN 1652471183", "NN 98713 98880", "NN9521499879", "NN96214 97180"),
  name = c(
    "Beinn Nibheis",
    "Beinn Macduibh",
    "Am Bràigh Riabhach",
