...
#https://www.ordnancesurvey.co.uk/geodesy-positioning/coordinate-transformations/tool
...
expect_equal(
  sgo_coordinates(sgo_transform(
    sgo_points(list(-3.09391641, 56.95563591), epsg = 4277),
    to = 4326
  )),
...
expect_equal(
  sgo_coordinates(sgo_transform(
    sgo_points(list(-3.09391642, 56.95563593), epsg = 4277),
    to = 4258
  )),
...
#to 4326
expect_equal(
  sgo_coordinates(sgo_transform(p, to = 4326)),
...
#to 4277
expect_equal(
  sgo_coordinates(sgo_transform(p, to = 4277)),
  to_mtx(c(-1.662925215, 53.61173358))
)
#to 27700
expect_equal(
  sgo_coordinates(sgo_transform(p, to = 27700)),
  to_mtx(c(422298.000, 412877.001))
)
#to 4258
expect_equal(
  sgo_coordinates(sgo_transform(p, to = 4258)),
  to_mtx(c(-1.6644422222, 53.6119903611))
)
#to 4936
expect_true(all(
...
#to 7405
expect_equal(
  sgo_coordinates(sgo_transform(p, to = 7405)),
...
expect_equal(
  sgo_transform(p, to = 7405, OD = TRUE)$height.datum,
